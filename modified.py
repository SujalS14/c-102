...
def upload_file(img_name):
    ...
    file =img_name
    file_from = file
    file_to=input("Enter Destination that you want to save the photo to:-")+(img_name)
    dbx = dropbox.Dropbox(access_token)

    with open(file_from, 'rb') as f:
        dbx.files_upload(f.read(), file_to,mode=dropbox.files.WriteMode.overwrite)
        print("you have got the photo you wanted, good job.... To me!!!!")
